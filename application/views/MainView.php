...
<!--[if IE]>
<link rel="stylesheet" media="all" type="text/css" href="<?php echo base_url(); ?>css/pro_dropline_ie.css" />
<![endif]-->
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>js/jquery.timepicker.css">
...
<div id="page-top">
	...
	<!-- start logo -->
	<div id="logo">
	<a href=""><img src="<?php echo base_url(); ?>images/convergys.png" width="156" height="52" alt="" /></a>
	</div>
	<!-- end logo -->
...
<div class="nav-outer"> 
		...
		<div id="nav-right">
			...
			<a href="<?php echo base_url(); ?>index.php/MyAccount"><div style="cursor: pointer;display: block;float: left;margin: 10px 5px 0 5px;"><img src="<?php echo base_url(); ?>images/shared/nav/nav_myaccount.gif" width="93" height="14" alt="" /></div></a>
			<div class="nav-divider">&nbsp;</div>
			<a href="<?php echo base_url(); ?>index.php/AttendanceSchedule/logout" id="logout"><img src="<?php echo base_url(); ?>images/shared/nav/nav_logout.gif" width="64" height="14" alt="" /></a>
			<div class="clear">&nbsp;</div>
		...
		<ul class="current"><li><a href="#nogo"><b>Attendance</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
			<div class="select_sub show">
			<ul class="sub">
				<li <?php if($main_content=="pages/AddScheduleView"){ echo "class='sub_show'"; }?>><a href="<?php echo base_url(); ?>index.php/AttendanceSchedule">Add Schedule</a></li>
				<?php if($access_level == "1") {?>
				<li <?php if($main_content=="pages/GenerateScheduleView"){ echo "class='sub_show'"; }?>><a href="<?php echo base_url(); ?>index.php/AttendanceSchedule/ProcessGenerateSchedule">Generate Schedule</a></li>
				<?php } ?>
			</ul>
		</div>	
		</li>
